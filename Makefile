NAME = push_swap
CC = gcc 
SRCS = ./srcs/main.c ./srcs/arg_check.c ./srcs/d_list_utils.c ./srcs/arg_parser.c ./srcs/ft_split_wc.c ./srcs/error_free.c ./srcs/push_swap.c ./srcs/quick_sort/ft_quick_sort.c ./srcs/tinysort/ft_tiny_sort.c ./srcs/instructions/pushes.c ./srcs/instructions/swaps.c ./srcs/instructions/rotates.c ./srcs/instructions/reverses.c ./srcs/layering.c
